<template>
  <div>
    <!-- Hero Section -->
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 pt-24 pb-10 text-start">
    ...
    <!-- Cards Section -->
    <section class="max-w-[1120px] mx-auto px-4 sm:px-6 lg:px-8 pb-32">
      <div class="flex flex-col lg:flex-row gap-4 items-stretch justify-center">
        <!-- Left: Form Card -->
        <div class="flex-[2.2] bg-[#0E0E0E] rounded-[32px] p-8 md:p-10 shadow-2xl relative overflow-hidden flex flex-col justify-between">
          <form @submit.prevent="handleSubmit" class="space-y-5 relative z-10 w-full">
            <div>
              <label class="block text-[15px] font-medium text-white mb-2">Name</label>
              <input 
                v-model="form.name" 
                type="text" 
                required
                placeholder="Jane Smith"
                class="w-full bg-[#1C1C1C] border-none rounded-2xl px-6 py-3.5 text-white placeholder-[#555555] focus:outline-none focus:ring-1 focus:ring-white/20 transition-all text-[16px]"
              />
            </div>

            <div>
              <label class="block text-[15px] font-medium text-white mb-2">Email</label>
              <input 
                v-model="form.email" 
                type="email" 
                required
            ...
            <div>
              <label class="block text-[15px] font-medium text-white mb-2">Your Message</label>
              <textarea 
                ...
                class="w-full bg-[#1C1C1C] border-none rounded-2xl px-6 py-4 text-white placeholder-[#555555] focus:outline-none focus:ring-1 focus:ring-white/20 transition-all resize-none text-[16px]"
              ></textarea>
            </div>
        ...
        <!-- Right: Info Card -->
        <div class="flex-1 bg-[#F5F5F5] rounded-[32px] p-6 md:p-10 flex flex-col justify-between relative group shadow-sm">
          <div class="space-y-10">
            <!-- Portrait -->
            <div class="w-20 h-20 rounded-[20px] overflow-hidden border-2 border-white">
              <img src="/pageweb/My.jpg" alt="Farhan Rizki" class="w-full h-full object-cover" />
            </div>

            <div class="space-y-4">
              <h2 class="text-[30px] md:text-[32px] font-medium leading-[1.15] tracking-tight text-gray-800">
                Learn more about me <span class="text-gray-500 font-medium">through my resume</span> below.
              </h2>
            </div>
          </div>
