  ...
  <div class="flex flex-col gap-1.5 w-full">
    ...
    <div class="relative w-full">
      <textarea
        ...
        :rows="rows"
        :class="[
          'w-full bg-[#1e1e1e] border rounded-xl px-4 py-3 text-[15px] text-white transition-all placeholder:text-white/20 focus:outline-none focus:ring-1 resize-none',
